  ...
  return (
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-8">
            <Link to={'/herosection'} className="border border-gray-200 p-4 rounded">
              <h3 className="font-medium mb-2">Hero section</h3>
              <p className="text-sm text-gray-500">Baner de inicio y titulos</p>
            </Link>
            <div className="border border-gray-200 p-4 rounded">
              <h3 className="font-medium mb-2">Gestión de Contenido</h3>
              <p className="text-sm text-gray-500">Edita el contenido de tu sitio</p>
            </div>
            <div className="border border-gray-200 p-4 rounded">
