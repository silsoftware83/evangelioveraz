...
const ParallaxSection: React.FC<ParallaxSectionProps> = ({
  ...
  // Calculate parallax effect - move background slower than foreground
  const parallaxStyle = {
  ...
  return (
    <div className="relative">
      ...
      <div className="relative z-20 bg-gray-700 text-white rounded-t-3xl -mt-16 min-h-screen">
        {children}
      </div>
    </div>
  );
  ...
  return (
    <div className="w-full">
      <ParallaxSection
        ...
        title="My Religion is a church that believes in Jesus, a church that loves God and people."
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-2/3 text-center md:text-left md:pl-8">
              <h2 className="text-4xl font-bold mb-2">Jeremy Thompson</h2>
              <p className="text-red-400 mb-6">Senior Pastor</p>
